...
class ContractTest {
    ...
    @Test void documentedRecordFieldsMatchJavaAndRefsExist() throws Exception {
        ...
        Map<String,Class<?>> records = Map.ofEntries(
                ...
                Map.entry("DeploymentResources",com.project.platform.deployment.service.DeploymentService.Resources.class),
                Map.entry("DeploymentRuntime",com.project.platform.deployment.service.DeploymentService.RuntimeView.class),
                Map.entry("DeploymentPod",com.project.platform.deployment.service.DeploymentService.PodInstance.class),
