...
try {
    ...
    Write-Output 'PASS: Maven verify. Inspect Surefire reports; includes S1-S3 regression and S4-01 resource catalog/locality tests. Real external tasks are not yet implemented.'
} finally {
