...
try {
    ...
    Write-Output 'PASS: Maven verify. Inspect Surefire reports; S1-S3 include real MySQL, Worker recovery, control flow, concurrency, Scheduler and migration tests.'
} finally {
