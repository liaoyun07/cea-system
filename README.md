...
FLPAR-12（2026-09-16，低客户端实测完成）：1/2/3客户端各3次正式全成功，平均速率494.85/546.14/540.08MB/s，总耗时30.92/32.45/34.54秒。原分片累计8333/25000/50000条，是减负载对比，不是固定总量加速比；84 Job/SDK、48模型192张量复核PASS。三个par12实验Flow已在CEA可见，原定义/数据/19服务不变、未重启。未达2GB/s。[结果与限制](docs/verification/VER-FLPAR-12-low-clients.md)。
